{
        ...
        c->cd(1);
        g1->SetTitle("T resolution (ps #sigma)");
        g1->GetXaxis()->SetTitle("ib1 (ADC)");
        g1->GetYaxis()->SetTitle("vbl (ADC)");
        g1->GetZaxis()->SetRangeUser(0, 200);
        g1->Draw("COLZ");
        
        c->cd(2);
        g2->SetTitle("E resolution (ns #sigma)");
        g2->GetXaxis()->SetTitle("ib1 (ADC)");
        g2->GetYaxis()->SetTitle("vbl (ADC)");
        g2->GetZaxis()->SetRangeUser(0, 2);
        g2->Draw("COLZ");
	
        c->cd(3);
        g3->SetTitle("T average (ps)");
        g3->GetXaxis()->SetTitle("ib1 (ADC)");
        g3->GetYaxis()->SetTitle("vbl (ADC)");
        g3->GetZaxis()->SetRangeUser(3.1E6, 3.3E6);
        g3->Draw("COLZ");
